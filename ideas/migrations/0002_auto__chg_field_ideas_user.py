...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Ideas.user'
        db.alter_column(u'ideas_ideas', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

    def backwards(self, orm):

        # Changing field 'Ideas.user'
        db.alter_column(u'ideas_ideas', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ideas.UserProfile']))
