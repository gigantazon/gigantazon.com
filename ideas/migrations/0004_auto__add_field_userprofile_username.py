...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'ideas_userprofile', 'username',
                      self.gf('django.db.models.fields.CharField')(default='temp', max_length=25),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.username'
        db.delete_column(u'ideas_userprofile', 'username')
