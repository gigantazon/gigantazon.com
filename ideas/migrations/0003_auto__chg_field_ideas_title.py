...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Ideas.title'
        db.alter_column(u'ideas_ideas', 'title', self.gf('django.db.models.fields.CharField')(max_length=250))

    def backwards(self, orm):

        # Changing field 'Ideas.title'
        db.alter_column(u'ideas_ideas', 'title', self.gf('django.db.models.fields.CharField')(max_length=128))
